...
def get_self_instruct_spec(num_respondents: int, num_beams: int=1,num_return_sequences=1,top_p=1,top_k=0,temperature=1,batch_size=0, exact_mode_str="false", template="false") -> RunSpec:
...
def get_vicuna_spec(num_respondents: int, category: str = "all", num_beams: int=1,num_return_sequences=1,top_p=1,top_k=0,temperature=1,batch_size=0, exact_mode_str="false", template="false") -> RunSpec:
    scenario_spec = ScenarioSpec(
...
def get_grammar_spec(num_respondents: int, path: str, tags: str, num_beams: int=1,num_return_sequences=1,top_p=1,top_k=0,temperature=1,batch_size=0, exact_mode_str="false", template="false") -> RunSpec:
    scenario_spec = ScenarioSpec(
...
def get_open_assistant_spec(num_respondents: int, language: str, num_beams: int=1,num_return_sequences=1,top_p=1,top_k=0,temperature=1,batch_size=0, exact_mode_str="false", template="false") -> RunSpec:
    scenario_spec = ScenarioSpec(
...
def get_koala_spec(num_respondents: int, num_beams: int=1,num_return_sequences=1,top_p=1,top_k=0,temperature=1,batch_size=0, exact_mode_str="false", template="false") -> RunSpec:
    scenario_spec = ScenarioSpec(
...
def get_anthropic_hh_rlhf_spec(num_respondents: int, subset: str, num_beams: int=1,num_return_sequences=1,top_p=1,top_k=0,temperature=1,batch_size=0, exact_mode_str="false", template="false") -> RunSpec:
    scenario_spec = ScenarioSpec(
